...
Допилить:<br>
<del>добавить удаление торрент-файлов после отправки их ботом! 100 файлов уже весят 8Мб!</del> <span style="color:red">Внематочно понаблюдать после того, как появится новинка в канале</span><br>
